...
document.getElementById("img-tutorial-0").addEventListener("click", () => {howToGaGa2("img-tutorial-0");});
document.getElementById("img-tutorial-0a").addEventListener("click", () => {howToGaGa2("img-tutorial-0a");});
