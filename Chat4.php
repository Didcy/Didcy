...
class Chat{
    ...
    public function __construct($chatTable){
	...
	public function getUserChat($from_user_id, $to_user_id) {
		...
		$conversation .= "</ul>";
		return array("conversation"=>$conversation, "chatMessages"=>$chatMessages
		, "count"=>$this->getMessageCount($to_user_id, $from_user_id));
	}
