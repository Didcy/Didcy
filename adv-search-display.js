...
//var modal_015, img_015, close15, caption15, modal_15_value = 0, res;
 ...
 var exhibitEventsFromLiveSearch = function($fetchID = null, drim = null, searchResults = null, clearContainerId = null, company_name_text = null, 
 fileTypeID = null){
			 ...
			 if($fetchID == 2){
               ...
               if(fileTypeID[i] == 0){
                elem.onclick = function(){
                 ...
                 var video_elem = document.createElement("embed");
                 video_elem.setAttribute("src", system_dirArr[i]);
