...
<!--   <script type="text/javascript" src="adv-sleep.js"></script>
 ...
 <script type="text/javascript">
  ...
  /*function reloadFromLogout(){
      ...
      var reloaderID =  window.location.href.slice(29);
...
/* 		if(reloaderID == "localhost/?id=1"){
	  ...
	  if(reloaderID != "" && reloaderID == 1){
		...
		//document.cookie="GAGA_RELATIONS=r99303922022;expires=Thu, 01 Jan 1970 00:00:00 UTC;path=/";	      
		document.cookie="GAGA_RESPONSE=;expires=Thu, 01 Jan 1970 00:00:00 UTC;GAGA_CMPO=;path=/";	      
		document.cookie="GAGA_CMPO=;expires=Thu, 01 Jan 1970 00:00:00 UTC;path=/";
...
@media screen and (min-height: 912px){
	...
	h3.cookie-h3-headers, h5.cookie-h5-headers, 
	address.cookie-hA-headers, p.policy-attribution{
	   font-size: 30px;
	}
}
.col-fixes, .col-ripa{
...
.modal-content-howToGaGa, .modal-howToGaGa{
  padding: 2px;
}
.modal-content-howToGaGa{
  top: 2%;
}
}
...
function ShowPassword(passwordValidator = null) {
  var pswdSignup = passwordValidator; //document.getElementById("input-pwd-signup");
  if (pswdSignup.type === "password") {
    pswdSignup.type = "text";
  } else {
    pswdSignup.type = "password";
  }
}
</script>
...
<div id="id01" class="modal-signup modal-signup-b">
  ...
  <form class="modal-content-signup" id="modal-content-signup" method="post">
    <div class="container-signup">
      <h1 class="signup-header1" id="signup-header1" style="color: SlateBlue">Didcy Sign Me-Up</h1>
...
<div id="id022" class="modal-signin modal-signup-b">
  ...
  <form class="modal-content-signin" id="modal-content-signin" method="post">
    <div class="container-signin">
      <h1 class="signup-header1" id="signup-header1" style="color: SlateBlue">Didcy Sign Me-In</h1>
...
<div id="adv-files" class="resx adv-files-1" style="display: none">
 <form id="adv-files">
 <input type="file" class="custom-file-input" name="uploads[]" disabled id="uploads" multiple enctype="form/multipart-data">
 <input type="submit" name="submit" class="upload" value="Upload" disabled id="upload" title="Get your ads viewed first before your competitors">
 </form>
...
<!-- <div id="resx">
  <h2 style="color: white;font-weight: bolder;padding-left:10px;letter-spacing: 3px;" class="didcx-welcome" id="didcx-welcome">DIDCY - WE'VE GOT YOUR BACK</h2>
</div> -->
...
<legend class="" id="">GaGa</legend>
 <form action="">
  <input type="text" class="usn" id="usn">
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content" id="img01">
    ...
    <div class="column-3">
	  ...
	  <button class="button" id="didcy-vice" style="display: none">Didcy Vice</button><!--Didcy Advice: On any subject matter: free including free therapy sessions: upcoming global call(phone no.) for sucide-->
...
<!--<div class="modal-other-e-services w3-animate-left" id="modal-other-e-services">
 <span class="close-other-e-services" id="close-other-e-services">&times;</span>
 <div class="modal-content-other-e-services" id="modal-content-other-e-services">
...
<script type="text/javascript">
  ...
  function closeChatBoard2(){
	  document.getElementById("close-chat-board-2").style.display = "none";
	  document.getElementById("myModal-chat-board").style.display = "none";
  }
  ...
  document.getElementsByClassName("login")[0].onclick = function(){login();}
							...
							function GetUpdate(from_user_id, to_user_id) {
								...
								form.append('drim', window.location.href.slice(53));
								$.ajax({
									type: 'POST',
									url: urls[2],
									data: form,
	 ...
	 $.ajax({
		...
		success: function(result){
			...
			//$(".messages").animate({ scrollTop: $('.messages').height() }, "fast");
			  ...
			  //document.getElementById("close-chat-board-2").style.display = "block";
			  //window.console.log(result);
			  //window.console.log("------");
...
<div class="modal-chat-board" id="myModal-chat-board" style="overflow-x: hidden">
 <span class="close-chat-board" id="close-chat-board" style="z-index: 20">&times;</span>
...
<div class="modal-ripa-board overlay" id="modal-ripa-board" style="overflow-y: auto">
 ...
 <h1 style="color: dodgerblue" class="welcome-header">Welcome to Ripa Services</h1>
  <p style="color: white" class="sub-header"><i class="sub-header">Use Ripa, Fund your DREAMS</i></p>
...
<div class="modal-didcy-ripa-bank modal-ripa-bank overlay" id="modal-ripa-bank" style="overflow-y: auto">
 ...
 <div class="modal-content-didcy-ripa-bank modal-content-ripa-bank" id="modal-content-ripa-bank">
   ...
   <h1 style="color: rgba(255, 100, 100, 1)" class="welcome-header">Welcome to Ripa Bank</h1>
   <p style="" class="sub-header">Please kindly read through <b class="sub-header" style="color: dodgerblue">Ripa Bank</b> manual for info. Thank you.</p>
...
<div class="modal-plugins-board overlay" id="modal-plugins-board" style="overflow-y: auto">
 ...
 <h1 style="color: dodgerblue" class="welcome-header">Welcome to DidcyFix</h1>
...
<div class="modal-didcy-fixes modal-split overlay" id="modal-split" style="overflow-y: auto">
 ...
 <div class="modal-content-didcy-fixes modal-content-split" id="modal-content-split">
   ...
   <h1 style="color: rgba(255, 100, 100, 1)" class="welcome-header">Welcome to Split</h1>
   <p style="" class="sub-header">Please kindly read through <b class="sub-header" style="color: dodgerblue">SPLIT</b> manual for info. Thank you.</p>
...
<div class="modal-didcy-fixes modal-quak overlay" id="modal-quak" style="overflow-y: auto">
 ...
 <div class="modal-content-didcy-fixes modal-content-quak" id="modal-content-quak">
   ...
   <h1 style="color: rgba(100, 100, 255, 1)" class="welcome-header">Welcome to Quak</h1>
   <p style="" class="sub-header">Please kindly read through <b class="sub-header" style="color: dodgerblue">QUAK</b> manual for info. Thank you.</p>
  ...
  <div class="modal-content-signup modal-content-work-apply" id="modal-content-work-apply">
	...
	<div class="container-didcy-work">
	  <form id="didcy-work-form">
		...
		<div class="row">
		  <div class="col-25">
			<label class="didcy-lab" for="mobile-number">Telephone No.</label><!--placeholder="Telephone number.."-->
		  </div>
		  <div class="col-75">
		   <input type="tel" class="didcy-tel" name="mobile-number" id="applicant-tel">
		  </div>
		</div>
		<div class="row">
		  <div class="col-25">
...
<div id="myModal-advertisement-channels" class="modal-advertisement-channels overlay">
  ...
  <div class="modal-content-advertisement-channels">
      <h1 style="color: white;text-align: center" class="hello-ex">Hello, Welcome to Didcy Channels</h1>
	  <div class="row-6">
...
<div id="myModal-companies-only" class="modal-companies-only overlay"  style="overflow-y: auto">
  ...
  <div class="modal-content-companies-only">
    <h2 style="color: white;text-align: left">Hello Didcer,</h2>
    <h1 style="color: white;text-align: center" class="hello-ex">Welcome to Didcy Companies Information</h1>
  </div>
</div>
...
<p>Our Privacy Policy governs your visit to <b>didcy.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Services.</p>
<p>We use your data to provide and improve our Services. By using our Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy have the same meanings as in our Terms and Conditions.</p>
...
<p><b>Other Data</b></p>
<p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, <a id="non-disclosure-agreement" href="https://policymaker.io/non-disclosure-agreement/">NDA agreements</a>, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.</p>
...
<p style="margin-top: 5em;" class="policy-attribution">This <a id="privacy-policy" href="https://policymaker.io/privacy-policy/">Privacy Policy</a> was created by <b>Didcy</b> on 2022-01-01.</p>
<br>
<br>
<br>
<br>
...
<p style="color: white" class="cookie-h3-headers">Subscription cookies are currently not available since it's features are also not available for use.</p>
...
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Apple Safari</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Google Chrome</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Microsoft Edge</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Microsoft Internet Explorer</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Mozilla Firefox</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Opera</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Android (Chrome)</a> 
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Blackberry</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Iphone or Ipad (Chrome)</a>
<a class="cookie-full-mode-link" href="" alt="" title="" target="">Iphone or Ipad (Safari)</a>
...
for(let queryLinks = 0; queryLinks < queryLength; queryLinks++){
	queryLinks4Default[queryLinks]
	document.getElementById("section").addEventListener("click", (event) =>{ event.preventDefault();});
}
...
<div class="form-inline-in" id="form-inline-in"> 
	<form class="form-inline" id="form-inline">
	<div class="form-inline-col-1" id="form-inline-col-1">
	  ...
	  <input type="email" name="business-email-of-offerer" placeholder="Business E-mail" id="business-email-of-offerer" class="business-email-of-offerer deal-offer deal-offer">
	  <input type="text" name="business-instagram-handle-of-offerer" placeholder="Business Instagram Handle [optional]" id="business-instagram-handle-of-offerer" class="business-instagram-of-offerer deal-offer deal-offer">
	  <input type="text" name="business-twitter-handle-of-offerer" placeholder="Business Twitter Handle [optional]" id="business-instagram-handle-of-offerer" class="business-twitter-of-offerer deal-offer deal-offer">
	  <input type="text" name="business-youtube-handle-of-offerer" placeholder="Business Youtube Handle [optional]" id="business-youtube-handle-of-offerer" class="business-youtube-of-offerer deal-offer deal-offer">
	  <select multiple id="countryOf-Offerer" class="cursor countryOf-Offerer" name="countryOf-Offerer">
		  <option name="" style="color: dodgerblue" selected>Country(ies) for ad display</option>	
		<option name="">Åland Islands</option>	
		<option name="">Afghanistan</option>	
		<option name="">Albania</option>	
		<option name="">Algeria</option>	
	...
	<div class="curtain-animate overlay-22">
	  ...
	  <div class="left2-animate">
		 ...
		 <h1 class="left1-animate">Our Team</h1>
          At long last, you've made it. 
		  Our team have being long waiting for you. 
		  Welcome Didcer, together we'll find solutions to our problems most 
...
<div id="myModal-upcoming-updates" class="modal-upcoming-updates">
  ...
  <div class="modal-content-upcoming-updates"> 
	 ...
	 <p style="color: white">Here at updates centre, Didcy preinforms you about
...
<div id="myModal-payment-services" class="modal-payment-services">
  ...
  <h1 style="color: white;padding-left: 10px" class="hello-didcer wel-didcy-uup" id="hello-didcer">Hello <span class="didcer-name" id="didcer-name">Didcer, </span></h1>
  <h1 style="color: white;text-align: center" class="wel-didcy-uup" id="">Welcome to Didcy Payment Method Selection Board Centre</h1>
	...
	<br>
  <div id="caption-payment-services" class="caption-payment-services">Didcy Pay</div>
</div>
...
<div id="myModal-15" class="modal-15">
  ...
  <span class="close-11" id="close-11">&times;</span>
	...
	<form class="form-newsletter" action="" id="form-newsletter" method="post">
	  ...
	  <div class="container-newsletter">
        ...
        <br/>
		<label class="container-checkbox"> Daily Newsletter
		  <input type="checkbox" checked="checked" name="subscribe" class="checkbox-newsletter" id="checkbox-newsletter">
		  <span class="checkmark"></span>
		</label>  
...
<div class="select-display-type-modal" id="select-display-type-modal">
  ...
  <div class="column-" id="column">  <!--& Groups -->
    <button class="button" id="video-ads" onclick="exhibitEvents(2, null, 'av')">Video Ads</button>
    <button class="button" id="audio-ads" onclick="exhibitEvents(14, null, 'au')">Audio Ads</button>
    <button class="button" id="" style="display: none" onclick="exhibitEvents(4, null, 'agp')">Actors Profile</button>
    <button class="button" id="" style="display: none" onclick="exhibitEvents(8, null, 'agp')">Companies Profile</button>
  ...
  <div id="caption-select-display-type-modal" class="caption-select-display-type-modal">Didcy Displays</div>
</div>

<!-- <div id="adv-files" class="resx adv-files" style="display: none">
 <form id="adv-files">
 <input type="file" name="uploads[]" id="uploads" multiple enctype="form/multipart-data">
...
<div class="form-company-registration-popup-2" id="myForm-company-registration-2">
  ...
  <form action="" class="form-company-registration-container-2">
    ...
    <input type="text" placeholder="Enter First Name" name="fname-company-registration" class="fname-company-registration" id="fname-company-registration" required>   
    ...
    <select name="activity-company-registration" class="activity-company-registration" id="activity-company-registration"> 
       <option>Select Your Company's Activity:</option>
	   <option name="">Mechnanic</option>
	   <option name="">Electronic</option>
	   <option name="">Tech</option>
	   <option name="">Agriculture</option>
...
<script type="text/javascript">
  ...
  document.getElementById("upload").addEventListener("click", () => uploads(document.forms['adv-files']));

  document.getElementById("static-ads").addEventListener("click", () => exhibitEvents(5, null));
  //exhibitEvents(3, drim.slice(51));
...
getImageFileName(document.getElementById('profile'), drim2.slice(51));//getCookieValue('GAGA_RESPONSE'));
</script>  -->
...
function SetDidcyLinks(){
	...
	if(window.location.href.slice(51) == ""){
	  drim =  "19200112993801028822991919-929lkkwowiiw00-lwwlw19991lmmcxcjwei9_292011";
		...
		drim = window.location.href.slice(51);
	}
	var did = null;
	{
	   document.getElementById("secure-my-domains").setAttribute("href", didcyLinks.secure_my_domains.link+drim);
...
<script type="text/javascript">
 "use strict";
  if(window.navigator.cookieEnabled == false){
      document.body.innerHTML = "<h1 style='font-size: 30px'>Cookie not enabled.#ERR_COOKIE_NOT_ENB</h1>";
